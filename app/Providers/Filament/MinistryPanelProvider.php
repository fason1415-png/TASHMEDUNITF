...
class MinistryPanelProvider extends PanelProvider
{
    public function panel(Panel $panel): Panel
    {
        return $panel
            ...
            ->discoverResources(in: app_path('Filament/MinistryPanel/Resources'), for: 'App\Filament\MinistryPanel\Resources')
            ->discoverPages(in: app_path('Filament/MinistryPanel/Pages'), for: 'App\Filament\MinistryPanel\Pages')
            ->pages([])
            ->discoverWidgets(in: app_path('Filament/MinistryPanel/Widgets'), for: 'App\Filament\MinistryPanel\Widgets')
            ->widgets([
